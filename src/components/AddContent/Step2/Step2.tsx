...
const Step2 = () => {
  const [collectionOpen, setCollectionsOpen] = useState<boolean>(true);
  ...
  return (
    <div className='fixed top-0 left-0 min-h-screen w-full flex flex-col items-center justify-between pt-16 px-7'>
          ...
          >
            ...
            {descriptionExpanded && (
              <div className='text-ga-text-gray text-center'>
                ...
                <p
                  className={`${textStyles.subtitle_1_normal} font-primary pb-4`}
                >
      ...
      {collectionOpen && <Collections onSave={onCollectionSave} />}
    </div>
  );
};
