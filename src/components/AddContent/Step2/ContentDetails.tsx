  ...
  return (
    <>
      <motion.div
        ...
        {!descriptionExpanded && (
          <ImageAdder contentImage={content.image || ''} contentTitle={content.title} />
        )}
        {!descriptionExpanded && (
        ...
        {descriptionExpanded && (
          <div className="text-ga-text-gray text-center">
            <h3 className={`${textStyles.heading_1} font-primary pb-2`}>Description</h3>
        ...
        <div
          ...
          <div
            ...
            } ${!descriptionExpanded ? styles.fadingParagraph : ''} break-words`}>
          ...
          <div className="flex justify-center flex-wrap gap-x-3 gap-y-3 pt-7 pb-16">
            {tags.map((tag, index) => (
              <TagChip
                ...
                index={index}
                tag={tag}
                selectedDefault={!!content.tags.find(selectedTag => selectedTag.id === tag.id)}
